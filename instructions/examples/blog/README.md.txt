Implement: examples/blog/README.md

# TASK
Implement the file `examples/blog/README.md` for the Bino full-stack framework.

# OVERVIEW
README describing how the example blog is structured and run with the bino CLI.
...
- If this file is a CLI command: do not start a blocking server — only implement the command's logic and an entrypoint function.
