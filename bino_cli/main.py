...
from .commands import create, install, dev, build, start
...
def create_project(
    ...
    try:
        ...
        create.create_project(target_dir, template)
...
def dev_server(
    ...
    try:
        dev.start_dev_server(host, port, reload)
...
def build_project(
    ...
    try:
        ...
        build.build_project(output_path, production)
...
def start_server(
    ...
    try:
        start.start_production_server(host, port, workers)
    except KeyboardInterrupt:
